...
if __name__ == "__main__":
    ...
    # python main.py -mode train -target_summary_sent abs -visible_gpus 0 -train_from 1209_1236/model_step_7000.pt
        ...
        param4 = (
            " -ext_dropout 0.1 -max_pos 512 -batch_size 5000 -accum_count 2"
            + " -lr 2e-3 -warmup_steps 1200 "  # 전체가 21632개인데  평균 9.6문장이니 207667문장/ 5000 = 41.5
            + "  -train_steps 20000 -save_checkpoint_steps 200  -report_every 10"
            + " -use_interval true"
        )
        do_str += param4
    ...
    # python main.py -mode valid -model_path 1209_1236
        ...
        """
        os.system(
            f"python train.py -task ext -mode validate -test_all True"
    ...
    # python main.py -mode test -test_from 1209_1236/model_step_7000.pt -visible_gpus 0
        ...
        os.system(
            f"python make_submission.py result_{model_folder}_{model_name}.candidate"
        )
